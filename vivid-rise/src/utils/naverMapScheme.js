...
export function openNaverMapPlaceUrl(placeUrl) {
  ...
  // 허용 도메인: map.naver.com, m.map.naver.com, m.place.naver.com, place.naver.com, naver.me(단축링크)
  if (!/^https?:\/\/((map\.|m\.map\.|m\.place\.|place\.)naver\.com|naver\.me)\//.test(url)) return;
  openUrl(url);
}
